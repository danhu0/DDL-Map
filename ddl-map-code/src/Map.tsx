...
// import "./map.css";
// import Papa from "papaparse";
// import PinEntry from "./PinEntry"; // import your PinEntry component
...
//   const [formOpen, setFormOpen] = useState(false); // NEW: form state
...
//     setFilteredPins(newFiltered);
//   }, [pins, startDate, endDate, timeMin, timeMax, licenseQuery]);

//   // Map rendering
//   useEffect(() => {
//     if (formOpen) return; // Do not render map if form is open
...
//   const handleTimeMinChange = (e: React.ChangeEvent<HTMLInputElement>) =>
//     setTimeMin(Math.min(parseInt(e.target.value, 10), timeMax));
//   const handleTimeMaxChange = (e: React.ChangeEvent<HTMLInputElement>) =>
//     setTimeMax(Math.max(parseInt(e.target.value, 10), timeMin));
...
//       {!formOpen && (
//         <button
//           className="pin-entry-float-button"
...
//       {/* Map */}
//       {!formOpen && <div id="map"></div>}

//       {/* Sidebar for pin */}
//       {selectedPin && !formOpen && (
//         <div className="sidebar">
//           <button className="close-btn" onClick={() => setSelectedPin(null)}>
//             ✕
//           </button>
...
//       {/* Fullscreen Form */}
//       {formOpen && <PinEntry onClose={() => setFormOpen(false)} />}
//     </div>
//   );
// };
